...
from evaluate.common.config import config_factory
from evaluate.common.loaders import load_prediction, load_gt, add_center_dist, filter_eval_boxes
from evaluate.tracking.algo import TrackingEvaluation
from evaluate.tracking.constants import AVG_METRIC_MAP, MOT_METRIC_MAP, LEGACY_METRICS
from evaluate.tracking.data_classes import TrackingMetrics, TrackingMetricDataList, TrackingConfig, TrackingBox, \
    TrackingMetricData
from evaluate.tracking.loaders import create_tracks
from evaluate.tracking.render import recall_metric_curve, summary_plot
from evaluate.tracking.utils import print_final_metrics,render_for_the_best_threshold
...
class TrackingEval:
    ...
    def render_curve(self, render_curves: bool = True) -> Dict[str, Any]:
        """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', default='/home/bailiping/Desktop/Radar_Perception_Project/Project_5/evaluate/mini_submission.json',type=str, help='The submission as a JSON file.')
    parser.add_argument('--output_dir', type=str, default='/home/bailiping/Desktop/Radar_Perception_Project/Project_5/evaluate/nuscenes-metrics',
    ...
    parser.add_argument('--config_path', type=str,default='/home/bailiping/Desktop/Radar_Perception_Project/Project_5/evaluate/tracking_config.json',
    ...
    parser.add_argument('--render_classes', type=str, default='bicycle+bus+car+motorcycle+pedestrian+trailer+truck', nargs='+',
    ...
    render_class='bicycle+bus+car+motorcycle+pedestrian+trailer+truck'
    ...
    nusc_eval.render_curve(render_curves=render_curves_)
