...
class TrackingEval:
    ...
    def visualization_all(self, render_curves: bool = True) -> Dict[str, Any]:
        """
        Main function that loads the evaluation code, visualizes samples, runs the evaluation and renders stat plots.
        :param render_curves: Whether to render PR and TP curves to disk.
        :return: The serialized TrackingMetrics computed during evaluation.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', default='/home/zhubinglab/Desktop/result.json',type=str, help='The submission as a JSON file.')
    parser.add_argument('--output_dir', type=str, default='/home/zhubinglab/Desktop/evaluate/nuscenes-metrics_trainval',
    ...
    parser.add_argument('--render_classes', type=str, default='bicycle+motorcycle+trailer+truck+bus+pedestrian+car', nargs='+',
    ...
    if config_path == '':
        cfg_ = config_factory('/home/zhubinglab/Desktop/nuScenes_Tracker/configs/tracking_config.json')
    else:
