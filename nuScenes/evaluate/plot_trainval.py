...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', default='/home/zhubinglab/Desktop/Radar_Perception_Project/Project_5/evaluate/val_submission.json',type=str, help='The submission as a JSON file.')
    parser.add_argument('--output_dir', type=str, default='/home/zhubinglab/Desktop/Radar_Perception_Project/Project_5/evaluate/nuscenes-metrics_trainval',
                        help='Folder to store result metrics, graphs and example visualizations.')
    parser.add_argument('--eval_set', type=str, default='val',
                        help='Which dataset split to evaluate on, train, val or test or mini_val.')
    parser.add_argument('--dataroot', type=str, default='/home/zhubinglab/Desktop/mmdetection3d/data/nuscenes',
