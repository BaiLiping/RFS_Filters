...
class TrackingEval:
    ...
    def visualize_all(self):
        """
        Printout all the bounding boxes in one frame
        """
        # Run visualization.
        self.render_all(self.nusc, self.tracks_gt, self.tracks_pred,self.output_dir,self.cfg.dist_th_tp)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', default='/home/zhubinglab/Desktop/val_submission.json',type=str, help='The submission as a JSON file.')
