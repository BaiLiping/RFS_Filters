...
def main():
    ...
    with open('/home/zhubinglab/Desktop/gt_results.json', 'w') as f:
        json.dump(gt_result,f,cls=NumpyEncoder)
    with open('/home/zhubinglab/Desktop/evaluation_results.json', 'w') as f:
        json.dump(gt_result,f,cls=NumpyEncoder)
    with open('/home/zhubinglab/Desktop/rectified_val_results.json', 'w') as f:
