...
def main():
    ...
    with open('/home/blp/Desktop/gt_results.json', 'w') as f:
        json.dump(gt_result,f,cls=NumpyEncoder)
    with open('/home/blp/Desktop/evaluation_results.json', 'w') as f:
        json.dump(gt_result,f,cls=NumpyEncoder)
    with open('/home/blp/Desktop/rectified_val_results.json', 'w') as f:
