...
'''
'''
lidar_3d_object_detection_inference_result_in_nuscenes_format_file='/home/zhubinglab/Desktop/mmdetection3d/data/nuscenes/official_inference_result/simpletrack_2hz_results_with_detection.json'
root_directory_for_dataset='/home/zhubinglab/Desktop/mmdetection3d/data/nuscenes'
dataset_version='v1.0-test'
'''
lidar_3d_object_detection_inference_result_in_nuscenes_format_file='/home/zhubinglab/Desktop/val_results.json'
root_directory_for_dataset='/home/zhubinglab/Desktop/mmdetection3d/data/nuscenes'
...
def main():
    ...
    #out_file_directory_for_this_experiment='/home/zhubinglab/Desktop/mmdetection3d/data/nuscenes/experiment_result/2022-01-15-15-07_birth0.0001_pd0.5_ps0.5'
    out_file_directory_for_this_experiment=root_directory_for_dataset
    # save the result for this classification
    with open('/home/zhubinglab/Desktop/val_results.json', 'r') as f:
        result=json.load(f)
