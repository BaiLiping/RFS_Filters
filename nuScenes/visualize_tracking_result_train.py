...
def parse_args():
    ...
    parser.add_argument('--detection_file',default='/home/zhubinglab/Desktop/MHT_train_submission.json', help='directory for the inference file')
...
def main(token, out_file_directory_for_this_experiment):
    ...
    with open('/home/zhubinglab/Desktop/train_submission.json', 'rb') as f:
    ...
    with open('/home/zhubinglab/Desktop/train_gt_track_record.json', 'rb') as f:
