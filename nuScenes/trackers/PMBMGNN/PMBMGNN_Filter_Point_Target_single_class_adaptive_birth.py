...
class PMBMGNN_Filter:
    ...
    """
    def update(self, frame_idx, egoposition, Z_k, filter_predicted, confidence_score=0, giou_gating=0.15):
        ...
        for measurement_index in range(number_of_measurements_from_current_frame):    
            ...
            if len(tracks_associated_with_this_measurement)>0: # If there are PPP components could be associated with current measurement.
                ...
                distanceB=math.sqrt((egoposition[0]-meanB_updated[0][0])**2+(egoposition[0]-meanB_updated[0][0])**2)
                if frame_idx!=0:
                    if classificationB_updated=='pedestrian' or classificationB_updated=='bicycle' or classificationB_updated=='motorcycle':
