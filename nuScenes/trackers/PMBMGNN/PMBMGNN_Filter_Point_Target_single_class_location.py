...
from utils.utils import associate_dets_to_tracks, compute_birth_rate_location
...
class PMBMGNN_Filter:
    ...
    def predict(self,egoposition,lag_time, filter_pruned,Z_k, birth_rate, noisy_region=1):
        ...
        base_birth_rate=birth_rate
        crowd_based_birth_rate=compute_birth_rate_location(Z_k,egoposition, self.classification)
        ...
        for new_birth_target_index in range(number_of_new_birth_targets):
            ...
            weightPois_birth = crowd_based_birth_rate[new_birth_target_index]
