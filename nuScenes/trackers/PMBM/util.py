...
def gen_filter_model(average_number_of_clutter_per_frame, p_S, p_D,classification, extraction_thr, ber_thr, poi_thr, eB_thr,ber_gating,use_ds_as_pd, P_init,use_giou=False, gating_mode='mahalanobis'):
    ...
    # PMBM filter pruning 
    filter_model['maximum_number_of_global_hypotheses'] = 50     # Maximum number of hypotheses(MBM components)
    filter_model['T_pruning_MBM'] = ber_thr   # Threshold for pruning multi-Bernoulli mixtures weights.
    filter_model['T_pruning_Pois'] = poi_thr   # Threshold for pruning PHD of the Poisson component.
